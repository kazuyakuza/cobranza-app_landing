# Contenido Landing Page - Cobranza App
...
Además, se pierde tiempo valioso en:

- Buscar comprobantes entre WhatsApp, correo y chats
- Verificar que las transferencias correspondan a las deudas correctas
...
**Contenido:**  
**Cobranza App** se encuentra actualmente en fase **Beta abierta**. Durante toda esta etapa el servicio es **100% gratuito**.

- Duración estimada de la Beta: 1 a 3 meses
- Todos los usuarios que se sumen durante esta etapa recibirán una bonificación especial al lanzarse la versión paga
- El producto se mejora constantemente según el feedback de los primeros usuarios
...
**Contenido:**  
No cobramos cuota fija mensual.  
Cobramos un **pequeño porcentaje** únicamente sobre los pagos que se procesan y concilian a través de la plataforma.

**Ejemplo:**  
Si generás $1.000.000 en deudas en un mes y $400.000 se pagan mediante el sistema, solo abonás el porcentaje sobre esos $400.000.

El cobro es mensual y transparente. Los porcentajes se definen de forma personalizada según volumen y características del cliente.
